...
const debug = require('debug')('cryptonia:pre-renderer')

const allCss = fs.readFileSync(__dirname + '/server.bundle.css', 'utf-8')

const SERVER_CSS_CACHE = {}

const getCriticalCSS = html =>
  new Promise((resolve, reject) => {
    //eslint-disable-next-line
    purify(html, allCss, { minify: !__DEV__ }, function(purifiedCss) {
...
const getCacheableCriticalCss = (html, req) => {
  ...
  if (process.env.DIST_MODE === '1') return Promise.resolve('')
