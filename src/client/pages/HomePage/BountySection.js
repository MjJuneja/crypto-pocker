...
const BountySection = props => {
  const cx = classnames(props.className, 'about-section','bounty-section')

  return (
    <div className={cx} id={props.id}>
      <div className="container page-section pb-0">
        <h4 className="section-title text-center mb-3">
          <Translate id="homepage.bounty.title" />
        </h4>
        <p className="mb-5">
          <Translate id="homepage.bounty.text_1" />
        </p>
        ...
        <p className="mb-5">
          <Translate id="homepage.bounty.text_2" />
        </p>
        <p>
          <Translate id="homepage.bounty.text_3" />
        </p>
      </div>
    </div>
  )
